...
class GetCreateLiveStreamResponseDTOTypedDict(TypedDict):
    ...
    r"""When set to true, FastPix records and stores the livestream for on-demand viewing. When set to false, the livestream is not recorded."""
    ...
    r"""Determines whether the recorded stream must be publicly accessible or private in Live to VOD (Video on Demand)."""
    ...
    low_latency: NotRequired[bool]
    r"""Enables low-latency streaming mode to reduce playback delay."""
    closed_captions: NotRequired[bool]
    r"""when provided true Enables closed captions for the livestream."""
    ...
    simulcast_responses: NotRequired[List[LiveSimulcastTypedDict]]
    r"""A list of simulcast responses created for the livestream."""
    media_ids: NotRequired[List[str]]
    r"""A list of media IDs created when recording is enabled. Each media ID represents a recorded video (Live to VOD). If the stream is stopped and started again outside the reconnect window, a new media ID is generated for each session."""
...
class GetCreateLiveStreamResponseDTO(BaseModel):
    ...
    low_latency: Annotated[Optional[bool], pydantic.Field(alias="lowLatency")] = None
    r"""Enables low-latency streaming mode to reduce playback delay."""
    ...
    simulcast_responses: Annotated[
        Optional[List[LiveSimulcast]], pydantic.Field(alias="simulcastResponses")
    ] = None
    r"""A list of simulcast responses created for the livestream."""
