...
class GetTimeseriesDataRequestTypedDict(TypedDict):
    ...
    """
    timespan: NotRequired[GetTimeseriesDataTimespan]
    r"""This parameter specifies the time span between which the video views list must be retrieved by. You can provide either from and to unix epoch timestamps or time duration. The scope of duration is between 60 minutes to 30 days.
...
class GetTimeseriesDataRequest(BaseModel):
    ...
    timespan: Annotated[
        Optional[GetTimeseriesDataTimespan],
...
class GetTimeseriesDataResponseBodyTypedDict(TypedDict):
    ...
    metadata: NotRequired[MetricsTimeseriesmetadataDetailsTypedDict]
...
class GetTimeseriesDataResponseBody(BaseModel):
    r"""Get filter/ dimension value details by dimension name."""

    success: Optional[bool] = None
    r"""Shows the request status. Returns true for success and false for failure."""

    metadata: Optional[MetricsTimeseriesmetadataDetails] = None
    r"""Retrieves breakdown values for a specified metric and timespan"""
...
GetTimeseriesDataResponseTypedDict = TypeAliasType(
    "GetTimeseriesDataResponseTypedDict",
    Union[DefaultErrorTypedDict, GetTimeseriesDataResponseBodyTypedDict],
)


GetTimeseriesDataResponse = TypeAliasType(
    "GetTimeseriesDataResponse", Union[DefaultError, GetTimeseriesDataResponseBody]
)
