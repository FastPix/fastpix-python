...
class SigningKeysPaginationTypedDict(TypedDict):
    r"""Pagination organizes content into pages for better readability and navigation."""

    total_records: NotRequired[int]
    r"""It gives the total number of Signing keys that are created by a user."""
...
class SigningKeysPagination(BaseModel):
    r"""Pagination organizes content into pages for better readability and navigation."""
