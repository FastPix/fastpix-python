...
UnusedDirectUploadResponseMediaQuality = Literal[
    "standard",
    "pro",
    "premium",
]
...
class UnusedDirectUploadResponseTypedDict(TypedDict):
    playback_ids: NotRequired[List[UnusedUploadsPlaybackIDTypedDict]]
    ...
    """
    media_quality: NotRequired[UnusedDirectUploadResponseMediaQuality]
    r"""The quality tier applied to the media."""
...
class UnusedDirectUploadResponse(BaseModel):
    playback_ids: Annotated[
        Optional[List[UnusedUploadsPlaybackID]], pydantic.Field(alias="playbackIds")
    ] = None
    ...
    media_quality: Annotated[
        Optional[UnusedDirectUploadResponseMediaQuality],
