...
class Metrics(BaseSDK):
    ...
    def list_breakdown_values(
        ...
        *,
        ...
        timespan: Optional[models.ListBreakdownValuesTimespan] = None,
        ...
        * **field:** The grouping field value based on the groupBy parameter.
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.ListBreakdownValuesResponseBody, http_res
            )
    ...
    def list_overall_values(
        ...
        *,
        ...
        measurement: Optional[str] = "avg",
        timespan: Optional[models.ListOverallValuesTimespan] = None,
        filterby: Optional[str] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        * **globalValue:** A global metric value that reflects the overall performance of the specified metric across the entire dataset for the given timespan. This value is not affected by specific filters.
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.ListOverallValuesResponseBody, http_res
            )
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.FastpixDefaultError(
    ...
    def get_timeseries_data(
        ...
        *,
        ...
        measurement: Optional[str] = "avg",
        timespan: Optional[models.GetTimeseriesDataTimespan] = None,
        filterby: Optional[str] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        * **numberOfViews:** The total number of views recorded during that interval, providing context for the metric value.
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.GetTimeseriesDataResponseBody, http_res
            )
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.FastpixDefaultError(
    ...
    def list_comparison_values(
        self,
        *,
        timespan: Optional[models.ListComparisonValuesTimespan] = None,
        filterby: Optional[str] = None,
        dimension: Optional[models.Dimension] = None,
        ...
        * **measurement:** Defines the aggregation type (for example, \"avg\", \"sum\", \"median\", \"95th\").
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.ListComparisonValuesResponseBody, http_res
            )
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.FastpixDefaultError(
