...
from fastpix_python import models, utils
from fastpix_python._hooks import SDKHooks
...
if TYPE_CHECKING:
    from fastpix_python.dimensions import Dimensions
    from fastpix_python.drmconfigurations import DrmConfigurations
    from fastpix_python.errors_sdk import Errors
    from fastpix_python.inputvideo import InputVideo
    from fastpix_python.invideoai import InVideoAI
    from fastpix_python.invideoaifeatures import InVideoAIFeatures
    from fastpix_python.liveplayback import LivePlayback
    from fastpix_python.livestreams import LiveStreams
    from fastpix_python.managelivestream import ManageLiveStream
    from fastpix_python.managevideos import ManageVideos
    from fastpix_python.media_sdk import MediaSDK
    from fastpix_python.mediatracks import MediaTracks
    from fastpix_python.metrics import Metrics
    from fastpix_python.playback import Playback
    from fastpix_python.playlist import Playlist
    from fastpix_python.playlists import Playlists
    from fastpix_python.signingkeys import SigningKeys
    from fastpix_python.simulcast import Simulcast
    from fastpix_python.simulcaststream import SimulcastStream
    from fastpix_python.startlivestream import StartLiveStream
    from fastpix_python.streams import Streams
    from fastpix_python.videos import Videos
    from fastpix_python.views_sdk import ViewsSDK
...
class Fastpix(BaseSDK):
    ...
    **Use case scenarios**   - **Token-based authentication:** Validate user access to premium or subscription-based content.   - **Key rotation:** Regularly rotate keys to reduce risk of compromise.   - **Protect intellectual property:** Prevent unauthorized distribution of valuable media assets.   - **Control usage:** Restrict access to specific users, groups, or contexts.   - **Prevent tampering:** Ensure requested assets have not been modified.   - **Time-bound access:** Enable signed URLs with expiration for controlled viewing windows.
    ...
    metrics: "Metrics"
    r"""Operations involving metrics"""
    errors: "Errors"
    r"""Operations involving errors"""
    _sub_sdk_map = {
        "input_video": ("fastpix_python.inputvideo", "InputVideo"),
        "manage_videos": ("fastpix_python.managevideos", "ManageVideos"),
        "media": ("fastpix_python.media_sdk", "MediaSDK"),
        "videos": ("fastpix_python.videos", "Videos"),
        "media_tracks": ("fastpix_python.mediatracks", "MediaTracks"),
        "in_video_ai_features": (
            "fastpix_python.invideoaifeatures",
            "InVideoAIFeatures",
        ),
        "in_video_ai": ("fastpix_python.invideoai", "InVideoAI"),
        "playback": ("fastpix_python.playback", "Playback"),
        "playlist": ("fastpix_python.playlist", "Playlist"),
        "playlists": ("fastpix_python.playlists", "Playlists"),
        "drm_configurations": ("fastpix_python.drmconfigurations", "DrmConfigurations"),
        "start_live_stream": ("fastpix_python.startlivestream", "StartLiveStream"),
        "live_streams": ("fastpix_python.livestreams", "LiveStreams"),
        "manage_live_stream": ("fastpix_python.managelivestream", "ManageLiveStream"),
        "streams": ("fastpix_python.streams", "Streams"),
        "live_playback": ("fastpix_python.liveplayback", "LivePlayback"),
        "simulcast_stream": ("fastpix_python.simulcaststream", "SimulcastStream"),
        "simulcast": ("fastpix_python.simulcast", "Simulcast"),
        "signing_keys": ("fastpix_python.signingkeys", "SigningKeys"),
