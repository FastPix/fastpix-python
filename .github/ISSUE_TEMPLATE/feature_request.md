...
about: Suggest a new feature or enhancement for the FastPix Python SDK
title: '[FEATURE] '
...
Thank you for suggesting a new feature for the FastPix Python SDK! Please provide the following information to help us understand and evaluate your request:
...
result = fastpix.your_new_feature()
```
...
```
<!-- How do other Python SDKs handle this? -->
```
## Priority
