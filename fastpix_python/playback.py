...
class Playback(BaseSDK):
    ...
    def create_media_playback_id(
        ...
        *,
        ...
        request = models.CreateMediaPlaybackIDRequest(
            media_id=media_id,
            request_body=models.CreateMediaPlaybackIDRequestBody(
    ...
    async def create_media_playback_id_async(
        self,
        *,
        media_id: str,
        access_policy: models.AccessPolicy,
    ...
    def delete_media_playback_id(
        ...
        *,
        ...
        :param media_id: Return the universal unique identifier for media which can contain a maximum of 255 characters.
        ...
        self._raise_for_status(
            ...
            [
                ("401", errors.InvalidPermissionErrorData, errors.InvalidPermissionError),
                ("403", errors.ForbiddenErrorData, errors.ForbiddenError),
                ("404", errors.MediaOrPlaybackNotFoundErrorData, errors.MediaOrPlaybackNotFoundError),
                ("422", errors.ValidationErrorResponseData, errors.ValidationErrorResponse),
            ],
        )

    async def delete_media_playback_id_async(
        self,
        *,
        media_id: str,
        playback_id: str,
    ...
    async def get_playback_id_async(
        self,
        *,
        media_id: str,
        playback_id: str,
