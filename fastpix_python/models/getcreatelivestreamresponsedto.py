...
from .simulcastresponse import SimulcastResponseData, SimulcastResponseDataTypedDict
...
class GetCreateLiveStreamResponseDTOTypedDict(TypedDict):
    ...
    r"""When set to true, the live stream is broadcast with reduced latency for closer-to-realtime delivery."""
    closed_captions: NotRequired[bool]
    r"""When set to true, the live stream emits closed-captions."""
    ...
    simulcast_responses: NotRequired[List[SimulcastResponseDataTypedDict]]
    r"""Collection of simulcast destinations configured for this stream."""
...
class GetCreateLiveStreamResponseDTO(BaseModel):
    ...
    simulcast_responses: Annotated[
        Optional[List[SimulcastResponseData]],
        pydantic.Field(alias="simulcastResponses"),
    ] = None
    r"""Collection of simulcast destinations configured for this stream."""
