...
class EventDetails(BaseModel):
    ...
    type: Annotated[
        OptionalNullable[str],
        pydantic.Field(alias="t", validation_alias=AliasChoices("t", "type")),
    ] = UNSET
    url: Annotated[
        OptionalNullable[str],
        pydantic.Field(alias="u", validation_alias=AliasChoices("u", "url")),
    ] = UNSET
    bitrate: Annotated[
        OptionalNullable[Union[str, int, float]],
        pydantic.Field(alias="br", validation_alias=AliasChoices("br", "bitrate")),
    ] = UNSET
    height: Annotated[
        OptionalNullable[Union[str, int]],
        pydantic.Field(alias="h", validation_alias=AliasChoices("h", "height")),
    ] = UNSET
    fps: OptionalNullable[Union[str, int, float]] = UNSET
    codec: Annotated[
        OptionalNullable[str],
        pydantic.Field(alias="cd", validation_alias=AliasChoices("cd", "codec")),
    ] = UNSET
    width: Annotated[
        OptionalNullable[Union[str, int]],
        pydantic.Field(alias="w", validation_alias=AliasChoices("w", "width")),
    ] = UNSET

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        """Mirror what the API actually returns.

        Only emit fields the user (or the API on parse) actually provided —
        i.e. fields present in ``__pydantic_fields_set__``. Every field on
        ``EventDetails`` is OptionalNullable with an UNSET default, so a
        field that was never set should be omitted from the output entirely
        rather than dumped as ``null``. This matches the spec's
        ``additionalProperties: true`` shape and exactly mirrors the wire
        response.
        """
        serialized = handler(self)
        out = {}
        for name, fld in type(self).model_fields.items():
            if name not in self.__pydantic_fields_set__:
                continue
...
class Event(BaseModel):
    event_name: Annotated[
        OptionalNullable[str],
        pydantic.Field(alias="e", validation_alias=AliasChoices("e", "e")),
    ] = UNSET
    r"""Name of the event.
    ...
    viewer_time: Annotated[
        ...
        pydantic.Field(alias="vt", validation_alias=AliasChoices("vt", "vt")),
    ] = UNSET
    r"""The unix epoch timestamp which represents the actual time the event has occured.
    ...
    player_playhead_time: Annotated[
        OptionalNullable[int],
        pydantic.Field(alias="pt", validation_alias=AliasChoices("pt", "pt")),
    ] = UNSET
    r"""The player_playhead_time represents the current position of the playhead (the point in the video that is being watched) on the video seekbar, measured in milliseconds. This value indicates how far into the video playback has progressed at any given moment.
    ...
    event_details: Annotated[
        ...
        pydantic.Field(alias="d", validation_alias=AliasChoices("d", "d")),
    ] = None
...
PlayerHeightTypedDict = TypeAliasType("PlayerHeightTypedDict", Union[int, float, str])
r"""Player Height refers to the vertical dimension, measured in pixels, of the video player as it appears on the webpage.

"""


PlayerHeight = TypeAliasType("PlayerHeight", Union[int, float, str])
r"""Player Height refers to the vertical dimension, measured in pixels, of the video player as it appears on the webpage.

"""


PlayerWidthTypedDict = TypeAliasType("PlayerWidthTypedDict", Union[int, float, str])
r"""Player Width refers to the width of the player displayed within the webpage, measured in pixels.

"""


PlayerWidth = TypeAliasType("PlayerWidth", Union[int, float, str])
r"""Player Width refers to the width of the player displayed within the webpage, measured in pixels.
