...
class PatchResponseDataTypedDict(TypedDict):
    ...
    r"""When true the stream emits closed captions."""
    enable_dvr_mode: NotRequired[bool]
    r"""When true viewers can pause/rewind during the live broadcast."""
    low_latency: NotRequired[bool]
    r"""When true the stream is broadcast with reduced latency."""
...
class PatchResponseData(BaseModel):
    ...
    closed_captions: Annotated[Optional[bool], pydantic.Field(alias="closedCaptions")] = None

    enable_dvr_mode: Annotated[Optional[bool], pydantic.Field(alias="enableDvrMode")] = None
