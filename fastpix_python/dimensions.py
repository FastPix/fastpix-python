...
class Dimensions(BaseSDK):
    def list_dimensions(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", CONTENT_TYPE_JSON):
            return unmarshal_json_response(models.ListDimensionsResponse, http_res)
        if utils.match_response(http_res, "400", CONTENT_TYPE_JSON):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
            )
            raise errors.BadRequestError(response_data, http_res)
        if utils.match_response(http_res, "401", CONTENT_TYPE_JSON):
            response_data = unmarshal_json_response(
                errors.InvalidPermissionErrorData, http_res
            )
            raise errors.InvalidPermissionError(response_data, http_res)
        if utils.match_response(http_res, "422", CONTENT_TYPE_JSON):
            response_data = unmarshal_json_response(
    ...
    async def list_dimensions_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    def list_filter_values_for_dimension(
        self,
        *,
        ...
        Related guide: <a href=\"https://fastpix.com/docs/working-with-video-data/explore-the-dashboard#filters-and-timeframes\">Filters and timeframes</a>
        ...
        if utils.match_response(http_res, "200", CONTENT_TYPE_JSON):
            return unmarshal_json_response(
                models.ListFilterValuesForDimensionResponse, http_res
            )
        if utils.match_response(http_res, "401", CONTENT_TYPE_JSON):
            response_data = unmarshal_json_response(
                errors.InvalidPermissionErrorData, http_res
            ...
            raise errors.InvalidPermissionError(response_data, http_res)
        if utils.match_response(http_res, "404", CONTENT_TYPE_JSON):
            response_data = unmarshal_json_response(
    ...
    async def list_filter_values_for_dimension_async(
        self,
        *,
        dimensions_id: models.DimensionsID,
        timespan: Optional[models.ListFilterValuesForDimensionTimespan] = None,
