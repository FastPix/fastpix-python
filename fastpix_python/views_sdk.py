...
class ViewsSDK(BaseSDK):
    ...
    def list_video_views(
        ...
        *,
        ...
        Each view in the response will include a unique `viewId`. You can use this `viewId` to call the <a href=\"https://fastpix.com/docs/video-data-api/views/get-video-view-details\">get details of video view</a> endpoint to retrieve more detailed information about that specific view.
    ...
    def get_video_view_details(
        ...
        *,
        ...
        self._raise_for_status(
            ...
            [
                ("401", errors.InvalidPermissionErrorData, errors.InvalidPermissionError),
                ("404", errors.ViewNotFoundErrorData, errors.ViewNotFoundError),
                ("422", errors.ValidationErrorResponseData, errors.ValidationErrorResponse),
            ],
        )
    ...
    def get_data_viewlist_current_views_get_timeseries_views(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", CONTENT_TYPE_JSON):
            return unmarshal_json_response(models.GetDataViewlistCurrentViewsGetTimeseriesViewsResponse, http_res)
        self._raise_for_status(
            http_res,
            [
                ("400", errors.BadRequestErrorData, errors.BadRequestError),
    ...
    def get_data_viewlist_current_views_filter(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", CONTENT_TYPE_JSON):
            return unmarshal_json_response(models.GetDataViewlistCurrentViewsFilterResponse, http_res)
        self._raise_for_status(
            http_res,
            [
                ("400", errors.BadRequestErrorData, errors.BadRequestError),
