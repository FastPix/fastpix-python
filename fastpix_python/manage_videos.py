...
MEDIA_TRACK_PATH = "/on-demand/{mediaId}/tracks/{trackId}"
...
class ManageVideos(BaseSDK):
    ...
    def get_media(
        ...
        * The `playbackId` is a unique identifier that allows you to stream the media once it is `ready`. You can construct the stream URL in this format: `https://stream.fastpix.com/<playbackId>.m3u8`
        ...
        :param media_id: The Media Id is assigned a universal unique identifier, which can contain a maximum of 255 characters.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
    ...
    def updated_media(
        ...
        *,
        ...
        request = models.UpdatedMediaRequest(
            media_id=media_id,
            request_body=models.UpdatedMediaRequestBody(
                metadata=metadata,
            ),
        )
        ...
        req = self._build_request(BuildRequestData(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                False,
                "json",
                models.UpdatedMediaRequestBody,
            ),
            timeout_ms=timeout_ms,
        ))
    ...
    def add_media_track(
        ...
        *,
        media_id: str,
        tracks: Optional[
            Union[models.AddTrackRequest, models.AddTrackRequestTypedDict]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        request = models.AddMediaTrackRequest(
            media_id=media_id,
            request_body=models.AddMediaTrackRequestBody(
                tracks=utils.get_pydantic_model(
                    tracks, Optional[models.AddTrackRequest]
                ),
            ),
        )
        ...
        req = self._build_request(BuildRequestData(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                False,
                "json",
                models.AddMediaTrackRequestBody,
            ),
            timeout_ms=timeout_ms,
        ))
    ...
    async def add_media_track_async(
        self,
        *,
        media_id: str,
        tracks: Optional[
    ...
    async def update_media_track_async(
        self,
        *,
        track_id: str,
        media_id: str,
    ...
    async def delete_media_track_async(
        self,
        *,
        media_id: str,
        track_id: str,
    ...
    def generate_subtitle_track(
        ...
        *,
        ...
        :param track_id: A universally unique identifier (UUID) assigned to the specific track for which subtitles should be generated.
        ...
        request = models.GenerateSubtitleTrackRequest(
            media_id=media_id,
            track_id=track_id,
            track_subtitles_generate_request=models.TrackSubtitlesGenerateRequest(
                language_name=language_name,
                metadata=metadata,
                language_code=language_code,
                title=title,
        ...
        req = self._build_request(BuildRequestData(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.track_subtitles_generate_request,
                False,
                False,
                "json",
                models.TrackSubtitlesGenerateRequest,
            ),
            timeout_ms=timeout_ms,
        ))
    ...
    async def generate_subtitle_track_async(
        self,
        *,
        media_id: str,
        track_id: str,
    ...
    def updated_source_access(
        ...
        *,
        ...
        request = models.UpdatedSourceAccessRequest(
            media_id=media_id,
            request_body=models.UpdatedSourceAccessRequestBody(
    ...
    async def updated_source_access_async(
        self,
        *,
        media_id: str,
        source_access: Optional[bool] = None,
    ...
    def updated_mp4_support(
        ...
        *,
        ...
        request = models.UpdatedMp4SupportRequest(
            media_id=media_id,
            request_body=models.UpdatedMp4SupportRequestBody(
        ...
        req = self._build_request(BuildRequestData(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                False,
                "json",
                models.UpdatedMp4SupportRequestBody,
            ),
            timeout_ms=timeout_ms,
        ))
    ...
    async def updated_mp4_support_async(
        self,
        *,
        media_id: str,
        mp4_support: models.UpdatedMp4SupportMp4Support,
    ...
    async def retrieve_media_input_info_async(
        self,
        *,
        media_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    def get_media_clips(
        ...
        *,
        ...
        :param source_media_id: The unique identifier of the source media.
        :param offset: Offset determines the starting point for data retrieval within a paginated list.
        ...
        req = self._build_request(BuildRequestData(
            method="GET",
            path="/on-demand/{sourceMediaId}/media-clips",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        self._raise_for_status(
            ...
            [
                ("401", errors.InvalidPermissionErrorData, errors.InvalidPermissionError),
                ("403", errors.ForbiddenErrorData, errors.ForbiddenError),
                ("404", errors.MediaClipNotFoundErrorData, errors.MediaClipNotFoundError),
                ("422", errors.ValidationErrorResponseData, errors.ValidationErrorResponse),
            ],
        )

    async def get_media_clips_async(
        self,
        *,
        source_media_id: str,
        offset: Optional[int] = 1,
